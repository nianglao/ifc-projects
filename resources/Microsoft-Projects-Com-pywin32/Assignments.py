...
class Assignments(DispatchBaseClass):
	CLSID = IID('{000C0C46-0000-0000-C000-000000000046}')
	coclass_clsid = None

	# Result is of type Assignment
	def Add(self, TaskID=defaultNamedOptArg, ResourceID=defaultNamedOptArg, Units=defaultNamedOptArg):
		ret = self._oleobj_.InvokeTypes(65526, LCID, 1, (9, 0), ((12, 17), (12, 17), (12, 17)),TaskID
			, ResourceID, Units)
		if ret is not None:
			ret = Dispatch(ret, u'Add', '{000C0C45-0000-0000-C000-000000000046}')
		return ret
	...
	def Item(self, Index=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, u'Item', '{000C0C45-0000-0000-C000-000000000046}')
		return ret
	...
	def UniqueID(self, Index=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, u'UniqueID', '{000C0C45-0000-0000-C000-000000000046}')
		return ret
	...
	def __call__(self, Index=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, '__call__', '{000C0C45-0000-0000-C000-000000000046}')
		return ret
	...
	def __iter__(self):
		...
		return win32com.client.util.Iterator(ob, '{000C0C45-0000-0000-C000-000000000046}')
...
win32com.client.CLSIDToClass.RegisterCLSID( "{000C0C46-0000-0000-C000-000000000046}", Assignments )
# -*- coding: mbcs -*-
# Created by makepy.py version 0.5.01
# By python version 2.7.16 (v2.7.16:413a49145e, Mar  4 2019, 01:37:19) [MSC v.1500 64 bit (AMD64)]
# From type library '{A7107640-94DF-1068-855E-00DD01075445}'
...
Assignments_vtables_dispatch_ = 1
Assignments_vtables_ = [
	...
	(( u'UniqueID' , u'Index' , u'retval' , ), 65521, (65521, (), [ (3, 1, None, None) , 
			(16393, 10, None, "IID('{000C0C45-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 80 , (3, 0, None, None) , 0 , )),
	(( u'Add' , u'TaskID' , u'ResourceID' , u'Units' , u'retval' , 
			), 65526, (65526, (), [ (12, 17, None, None) , (12, 17, None, None) , (12, 17, None, None) , (16393, 10, None, "IID('{000C0C45-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 3 , 88 , (3, 0, None, None) , 0 , )),
	(( u'Item' , u'Index' , u'retval' , ), 0, (0, (), [ (12, 1, None, None) , 
			(16393, 10, None, "IID('{000C0C45-0000-0000-C000-000000000046}')") , ], 1 , 2 , 4 , 0 , 96 , (3, 0, None, None) , 0 , )),
